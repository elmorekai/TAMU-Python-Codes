...
# Section:      545
# Team:         N/A
# Assignment:   Lab 2b Program 2a (e.g. Lab 1b-2)
# Date:         09/03/2020

# Write a program that will take two observed 3D positions at two points in 
# time, and then calculate the a 3D position at a third point in time, t0,
# between the two points at time t1 and t2. 
